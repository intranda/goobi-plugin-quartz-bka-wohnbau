...
This plugin for Goobi workflow executed automatic imports of data from the file system to create or enrich processes and to copy and convert media files.
